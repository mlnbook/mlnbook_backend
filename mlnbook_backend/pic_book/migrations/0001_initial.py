    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("seq", models.SmallIntegerField(default=1, verbose_name="顺序")),
                ("ctime", models.DateTimeField(auto_now_add=True)),
                ("utime", models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "background_img",
                    models.ImageField(blank=True, max_length=500, null=True, upload_to="", verbose_name="背景图面"),
                ),
                (
                    "background_color",
                    models.ImageField(default="#FFFFFF", max_length=500, upload_to="", verbose_name="背景颜色"),
                ),
                (
                    "text_flex_justify",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("seq", models.SmallIntegerField(default=1, verbose_name="页内段落排序")),
                ("ctime", models.DateTimeField(auto_now_add=True)),
                ("utime", models.DateTimeField(auto_now=True)),
            ],
            options={
