...
class KnowledgePoint(models.Model):
    ...
    illustration = models.ImageField("默认插图", upload_to="pic_books/illustration/", blank=True, null=True)
    small_illustration = models.ImageField("缩略插图", upload_to="pic_books/small_illustration/", blank=True, null=True)
...
class Paragraph(models.Model):
    ...
    illustration = models.ImageField("插图", upload_to="pic_books/illustration/", blank=True, null=True)
    small_illustration = models.ImageField("插图", upload_to="pic_books/small_illustration/", blank=True, null=True)
    aigc_prompt = models.CharField("生成式提示词", max_length=500, blank=True, null=True)
    aigc_payload = models.JSONField("生成式提交的json", blank=True, null=True, help_text="参考stable diffusion API")
